...
2. Observe the kernel log while plugging GPIB-USB-HS into the computer, the output should be:
```
$ sudo dmesg -w
...
On [Gentoo](https://wiki.gentoo.org/wiki/Handbook:Main_Page), `sudo emerge linux-gpib` is all that is necessary, you do not need to install this repo. The testing and troubleshooting secions of this README still apply.
