...
grep "Debian GNU/Linux 12" /etc/issue || { echo "This script requires Debian 12" ; exit 1 ; }
set -x

module_path=$(python3 << EOF
from importlib import resources
with resources.path('linux_gpib_installer', '_linux_gpib_installer_debian_12.sh') as rp:
